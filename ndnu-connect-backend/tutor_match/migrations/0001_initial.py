# Generated by Django 3.0.3 on 2020-03-17 04:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('ACC', 'Accounting'), ('ART', 'Art'), ('GPY', 'Art Therapy'), ('BIO', 'Biology'), ('BUS', 'Business Administration'), ('CHE', 'Chemistry'), ('CPY', 'Clinical Psychology'), ('COM', 'Communication'), ('CSC', 'Computer Science'), ('EDU', 'Education'), ('ENG', 'English'), ('TSL', 'English as a Second Language'), ('HSC', 'Health Sciences'), ('HST', 'History'), ('HSP', 'Human Services'), ('KIN', 'Kinesiology'), ('', 'Liberal Studies'), ('MTH', 'Mathematics'), ('PHL', 'Philosophy'), ('PSC', 'Political Science'), ('PSY', 'Psychology'), ('REL', 'Religious Studies'), ('SOC', 'Sociology'), ('SPA', 'Spanish Studies')], max_length=3, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Schedule',
